...
public class BotKeyboardFactory {
    ...
    // Añade esto a BotKeyboardFactory si quieres un teclado más limpio para práctica
    public static ReplyKeyboardMarkup crearTecladoPractica(int numOpciones) {
        ReplyKeyboardMarkup teclado = new ReplyKeyboardMarkup();
        teclado.setResizeKeyboard(true);
        teclado.setOneTimeKeyboard(false);
        ...
        // Fila de control único
        KeyboardRow filaControl = new KeyboardRow();
        filaControl.add("Fin");
